...
class QuotationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quotation" do
    assert_difference('Quotation.count') do
      post quotations_url, params: { quotation: { customer_id: @quotation.customer_id, date: @quotation.date, details: @quotation.details, value: @quotation.value } }
    end
  ...
  test "should update quotation" do
    patch quotation_url(@quotation), params: { quotation: { customer_id: @quotation.customer_id, date: @quotation.date, details: @quotation.details, value: @quotation.value } }
